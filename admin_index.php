  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
       ...
       <!--Container koji drži pozadinsku sliku - trading view BNB-a 6.1.2022. -->
        <div class="container2">
            <a href="/whatIsWeb3.php" class="h1WhatIsWeb3">Što je Web 3?</a>
            <img src="/images/bg-chart.png" class="bg-chart">
        </div>
...
<div class="container mb-5" style="margin-top: 15em !important;">
        <div class="row">
            <?php foreach($query as $q){ ?>
                    <div class="card text-white bg-white mx-auto mb-5 " style="width: 18rem;">
                        <div class="card-body">
                            <?php echo "<img src='slike_objava/".$q['slika_objave']."' class='card-img-top'>"; ?>
      ...
      <?php
            if (isset($_SESSION['admin_id']) && isset($_SESSION['admin_username'])) {
              echo ' <li class="nav-item"><a href="admin_pregled_profila.php" class="nav-link px-2 text-muted">Profil</a></li>';
            }else{
              echo ' <li class="nav-item"><a href="admin-prijava.php" class="nav-link px-2 text-muted">Prijava</a></li>';
            }
          ?>
